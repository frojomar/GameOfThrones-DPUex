...
import dp.GameOfThrones.Juego.Targaryen;
...
public class TargaryenTest {
	...
	public void testEqualsObject() {
		Personaje p1= new Targaryen();
		Personaje p2= new Targaryen();
		Personaje p3= new Targaryen("Jaime",'J',3);
		Personaje p4= new Targaryen("Joffrey", 'J',3);
		Personaje p5= new Targaryen("Cersei", 'C', 3);
		Personaje p6= new Targaryen("Cersei", 'C', 4);
		Personaje p7= new Targaryen("Tyrion", 'T', 5);
		Personaje p8= new Targaryen("Tyrion", 'L', 5);
