...
/**
 * Defensa Diciembre - proyecto16_17
 * Implementacion de la clase LannisterNeo(subclase de Defensor).
 *
 * @version 1.0
 * @author
 ...
 * Curso 16/17
 */
public class LannisterNeo extends Defensor {	
		/**Constructor por defecto de la clase Lannister
		 * 
		 */
		public LannisterNeo(){
			super("LannisterNeo", 'N', 1);
			this.cargarLlaves();
		}
		 ...
		 */
		public LannisterNeo(String nombre, char c, int turno) {
