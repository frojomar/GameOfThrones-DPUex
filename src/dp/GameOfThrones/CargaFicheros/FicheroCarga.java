...
import dp.GameOfThrones.Excepciones.CondAltException;
import dp.GameOfThrones.Excepciones.DimensionesException;
import dp.GameOfThrones.Excepciones.SalaPuertaException;
import dp.GameOfThrones.Excepciones.TurnoException;
...
public class FicheroCarga {
	...
	*/
	 ...
	 */
	 public static void procesarFichero(String nombreFichero, Cargador cargador) throws  FileNotFoundException, IOException, DimensionesException, SalaPuertaException, CondAltException, TurnoException {
